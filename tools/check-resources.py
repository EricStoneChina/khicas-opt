...
report={'scope':'SH4 linker/binary capacity and single compiler stack frames; no CG50 runtime measurements',
        ...
        'sha256':{name:hashlib.sha256((d/name).read_bytes()).hexdigest() for name in ('khicas50.g3a','khicas50.ac2','khicasen.elf','prizm.ld','main.cc','kglobal.cc','static_lexer_.h','zmaple.cc','yintg.cc','ksubst.cc','equation_normalize.h','parametric_display.h','kconvert.cc','zprog.cc','input_lexer.cc','input_lexer.ll')}}
