...
for sig in ('  void decompose_prod(', '  gen extract_cst(',
            ...
            '  static bool integrate_quartic_trig(', '  static bool integrate_high_frequency_trig(', '  static bool integrate_compact_primitive(',
            ...
            '  static bool integrate_compact_definite(',
