...
const char apropos_string[]="\x01""Khicas 1.8.0 \xd6\xd0\xce\xc4\xb0\xe6 (c) 2024 B. Parisse et al.\n\x01""\xd3\xc9 EricStoneChina \xb9\xb9\xbd\xa8 (2026)\n\x01""\xcf\xee\xc4\xbf\xcd\xf8\xd5\xbe: https://ericstonechina.github.io/khicas-opt/\n\x01""License GPL version 2.\n\x01""Interface adapted from Eigenmath for Casio, by G. Maia, http://gbl08ma.com, Mike Smith, Nemhardy, LePhenixNoir\n\x01""Special thanks to LePhenixNoir, planet-casio and tiplanet\n\x01""\n\x01""Do not use if CAS calculators are forbidden!";
